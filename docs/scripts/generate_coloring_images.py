...
def gradient_color_image(method):
...
for i, method in enumerate(METHODS):
    ...
    plt.title(method)
    gradient_color_image(getattr(hector_math.coloring.GradientMethod, method))
plt.tight_layout()
